function Test_Sensor_Drift
% A simple test to ensure the sensor values from the force torque sensor
% are constant under constant load
filename = 'One_KG_Load';
...
plot(time,force_plot(:,3),t_sl,sl_pfz)
xlabel('time (s)')
ylabel('Force (N)')
title('Sensor Data From ATI AXIA80')
legend('$F_z$','Filtered $F_z$','Location','southeast')
