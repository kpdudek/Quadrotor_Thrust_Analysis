...
%analysis can occur
file = 'R2_2018_06_05_4Corners_Manual';
...
hold on
plot(a_ty_p)
save([mfilename '_data_2018_06_05_4Corners_Manual'],'a_fz','a_tx','a_ty','a_tz','a_o1','a_o2','a_o3','a_o4')
...
plot(ax_s1,t1,s1)
hold on
[pks1,locs1] = findpeaks(s1,'MinPeakHeight',1260,'MinPeakDistance',5);
...
plot(ax_s2,t2,s2)
hold on
[pks2,locs2] = findpeaks(s2,'MinPeakHeight',.06,'MinPeakDistance',60);
plot(ax_s2,t2(locs2),pks2,'ko')

o2_init = s1(1:(locs1(12)+20));
ty_init = s2(1:(locs2(4)+200));
