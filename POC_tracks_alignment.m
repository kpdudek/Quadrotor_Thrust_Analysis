...
%analysis can occur
file = 'R2_2018_06_05_4Corners_Acro';
...
hold on
plot(a_ty_p)
save([mfilename '_data_2018_06_05_4Corners_Acro'],'a_fz','a_tx','a_ty','a_tz','a_o1','a_o2','a_o3','a_o4')
...
plot(ax_s2,t2,s2)
hold on
[pks2,locs2] = findpeaks(s2,'MinPeakHeight',.06,'MinPeakDistance',80);
